...
const Missions = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="mb-6 text-3xl font-bold text-[#9b87f5]">Missions</h1>
      ...
      {isLoading ? (
        ...
        <p className="text-center text-lg text-gray-400">No missions available at the moment.</p>
      ) : (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {missions.map((mission) => (
            <Card key={mission.id} className={`border-[${isActive(mission) ? '#9b87f5' : 'gray'}/50] bg-[#221F26] text-white overflow-hidden`}>
                      ...
                      <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                          ...
                          <Input
                            ...
                            className="col-span-3 bg-[#1A191C] border-gray-700"
                            required
                          />
                        </div>
