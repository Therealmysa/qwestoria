...
const Messages = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[#0a0a12] via-[#1a1625] to-[#2a1f40] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        {/* Header fixe */}
        <div className="flex-shrink-0 p-4 border-b border-white/15 bg-black/20 backdrop-blur-2xl">
        ...
        <div className="flex-1 min-h-0 p-4">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            ...
            {/* Contenu des tabs avec scroll isolé */}
            <div className="flex-1 min-h-0">
              <TabsContent value="messages" className="h-full m-0">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                  ...
                  {/* Zone de messages avec layout parfait */}
                  <div className="lg:col-span-2 h-full">
                    <Card className="h-full bg-black/15 backdrop-blur-2xl border border-white/15 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 transform hover:scale-[1.02] flex flex-col">
                      {selectedConversation && selectedUser ? (
                        <>
                          {/* Header de conversation fixe */}
                          <CardHeader className="flex-shrink-0 border-b border-white/15">
                          ...
                          {/* Zone de messages avec scroll contrôlé */}
                          <div className="flex-1 min-h-0">
                            {messagesLoading ? (
                          ...
                          {/* Zone d'envoi de messages TOUJOURS VISIBLE */}
