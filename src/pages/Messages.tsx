...
const Messages = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0a0a12] via-[#1a1625] to-[#2a1f40] relative overflow-hidden">
      ...
      {/* Header fixe */}
      <div className="relative z-10 p-4 border-b border-white/15 bg-black/20 backdrop-blur-2xl">
      ...
      <div className="relative z-10 h-[calc(100vh-120px)] p-4">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          {/* Tabs navigation */}
          <div className="bg-black/20 backdrop-blur-2xl border border-white/15 rounded-2xl p-4 mb-4 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300">
          ...
          {/* Contenu des tabs avec hauteur fixe et scroll */}
          <div className="flex-1 min-h-0">
            <TabsContent value="messages" className="h-full m-0">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                {/* Liste des conversations */}
                <Card className="lg:col-span-1 bg-black/15 backdrop-blur-2xl border border-white/15 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 transform hover:scale-[1.02] flex flex-col h-full">
                ...
                {/* Zone de messages */}
                <Card className="lg:col-span-2 bg-black/15 backdrop-blur-2xl border border-white/15 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 transform hover:scale-[1.02] flex flex-col h-full">
                  {selectedConversation && selectedUser ? (
                    <>
                      ...
                      {/* Zone d'envoi de messages fixe en bas */}
